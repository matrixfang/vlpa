...
class StateNodeMap(_object):
    ...
    __repr__ = _swig_repr
    def iterator(self): return _infomap.StateNodeMap_iterator(self)
    def __iter__(self): return self.iterator()
    def __nonzero__(self): return _infomap.StateNodeMap___nonzero__(self)
    def __bool__(self): return _infomap.StateNodeMap___bool__(self)
    def __len__(self): return _infomap.StateNodeMap___len__(self)
    def __getitem__(self, *args): return _infomap.StateNodeMap___getitem__(self, *args)
    def __delitem__(self, *args): return _infomap.StateNodeMap___delitem__(self, *args)
    def has_key(self, *args): return _infomap.StateNodeMap_has_key(self, *args)
    def keys(self): return _infomap.StateNodeMap_keys(self)
    def values(self): return _infomap.StateNodeMap_values(self)
    def items(self): return _infomap.StateNodeMap_items(self)
    def __contains__(self, *args): return _infomap.StateNodeMap___contains__(self, *args)
    def key_iterator(self): return _infomap.StateNodeMap_key_iterator(self)
    def value_iterator(self): return _infomap.StateNodeMap_value_iterator(self)
    def __iter__(self): return self.key_iterator()
    def iterkeys(self): return self.key_iterator()
    def itervalues(self): return self.value_iterator()
    def iteritems(self): return self.iterator()
    def __setitem__(self, *args): return _infomap.StateNodeMap___setitem__(self, *args)
    def __init__(self, *args): 
        this = _infomap.new_StateNodeMap(*args)
        try: self.this.append(this)
        except: self.this = this
    def empty(self): return _infomap.StateNodeMap_empty(self)
    def size(self): return _infomap.StateNodeMap_size(self)
    def clear(self): return _infomap.StateNodeMap_clear(self)
    def swap(self, *args): return _infomap.StateNodeMap_swap(self, *args)
    def get_allocator(self): return _infomap.StateNodeMap_get_allocator(self)
    def begin(self): return _infomap.StateNodeMap_begin(self)
    def end(self): return _infomap.StateNodeMap_end(self)
    def rbegin(self): return _infomap.StateNodeMap_rbegin(self)
    def rend(self): return _infomap.StateNodeMap_rend(self)
    def count(self, *args): return _infomap.StateNodeMap_count(self, *args)
    def erase(self, *args): return _infomap.StateNodeMap_erase(self, *args)
    def find(self, *args): return _infomap.StateNodeMap_find(self, *args)
    def lower_bound(self, *args): return _infomap.StateNodeMap_lower_bound(self, *args)
    def upper_bound(self, *args): return _infomap.StateNodeMap_upper_bound(self, *args)
...
class UIntDeque(_object):
    ...
    __repr__ = _swig_repr
    def iterator(self): return _infomap.UIntDeque_iterator(self)
    def __iter__(self): return self.iterator()
    def __nonzero__(self): return _infomap.UIntDeque___nonzero__(self)
    def __bool__(self): return _infomap.UIntDeque___bool__(self)
    def __len__(self): return _infomap.UIntDeque___len__(self)
    def pop(self): return _infomap.UIntDeque_pop(self)
    def __getslice__(self, *args): return _infomap.UIntDeque___getslice__(self, *args)
    def __setslice__(self, *args): return _infomap.UIntDeque___setslice__(self, *args)
    def __delslice__(self, *args): return _infomap.UIntDeque___delslice__(self, *args)
    def __delitem__(self, *args): return _infomap.UIntDeque___delitem__(self, *args)
    def __getitem__(self, *args): return _infomap.UIntDeque___getitem__(self, *args)
    def __setitem__(self, *args): return _infomap.UIntDeque___setitem__(self, *args)
    def append(self, *args): return _infomap.UIntDeque_append(self, *args)
    def empty(self): return _infomap.UIntDeque_empty(self)
    def size(self): return _infomap.UIntDeque_size(self)
    def clear(self): return _infomap.UIntDeque_clear(self)
    def swap(self, *args): return _infomap.UIntDeque_swap(self, *args)
    def get_allocator(self): return _infomap.UIntDeque_get_allocator(self)
    def begin(self): return _infomap.UIntDeque_begin(self)
    def end(self): return _infomap.UIntDeque_end(self)
    def rbegin(self): return _infomap.UIntDeque_rbegin(self)
    def rend(self): return _infomap.UIntDeque_rend(self)
    def pop_back(self): return _infomap.UIntDeque_pop_back(self)
    def erase(self, *args): return _infomap.UIntDeque_erase(self, *args)
    def __init__(self, *args): 
        this = _infomap.new_UIntDeque(*args)
        try: self.this.append(this)
        except: self.this = this
    def push_back(self, *args): return _infomap.UIntDeque_push_back(self, *args)
    def front(self): return _infomap.UIntDeque_front(self)
    def back(self): return _infomap.UIntDeque_back(self)
    def assign(self, *args): return _infomap.UIntDeque_assign(self, *args)
    def resize(self, *args): return _infomap.UIntDeque_resize(self, *args)
    def insert(self, *args): return _infomap.UIntDeque_insert(self, *args)
    def pop_front(self): return _infomap.UIntDeque_pop_front(self)
    def push_front(self, *args): return _infomap.UIntDeque_push_front(self, *args)
...
class Infomap(_object):
    ...
    def readInputData(self, *args): return _infomap.Infomap_readInputData(self, *args)
    def addLink(self, *args): return _infomap.Infomap_addLink(self, *args)
    def run(self): return _infomap.Infomap_run(self)
    __swig_setmethods__["config"] = _infomap.Infomap_config_set
    __swig_getmethods__["config"] = _infomap.Infomap_config_get
    if _newclass:config = _swig_property(_infomap.Infomap_config_get, _infomap.Infomap_config_set)
    __swig_setmethods__["network"] = _infomap.Infomap_network_set
    __swig_getmethods__["network"] = _infomap.Infomap_network_get
    if _newclass:network = _swig_property(_infomap.Infomap_network_get, _infomap.Infomap_network_set)
    __swig_setmethods__["tree"] = _infomap.Infomap_tree_set
    __swig_getmethods__["tree"] = _infomap.Infomap_tree_get
    if _newclass:tree = _swig_property(_infomap.Infomap_tree_get, _infomap.Infomap_tree_set)
...
class MemInfomap(_object):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _infomap.new_MemInfomap(*args)
        try: self.this.append(this)
        except: self.this = this
    def readInputData(self, *args): return _infomap.MemInfomap_readInputData(self, *args)
    def addTrigram(self, *args): return _infomap.MemInfomap_addTrigram(self, *args)
    def addStateLink(self, *args): return _infomap.MemInfomap_addStateLink(self, *args)
    def addMultiplexLink(self, *args): return _infomap.MemInfomap_addMultiplexLink(self, *args)
    def run(self): return _infomap.MemInfomap_run(self)
    __swig_setmethods__["config"] = _infomap.MemInfomap_config_set
    __swig_getmethods__["config"] = _infomap.MemInfomap_config_get
    if _newclass:config = _swig_property(_infomap.MemInfomap_config_get, _infomap.MemInfomap_config_set)
    __swig_setmethods__["network"] = _infomap.MemInfomap_network_set
    __swig_getmethods__["network"] = _infomap.MemInfomap_network_get
    if _newclass:network = _swig_property(_infomap.MemInfomap_network_get, _infomap.MemInfomap_network_set)
    __swig_setmethods__["tree"] = _infomap.MemInfomap_tree_set
    __swig_getmethods__["tree"] = _infomap.MemInfomap_tree_get
    if _newclass:tree = _swig_property(_infomap.MemInfomap_tree_get, _infomap.MemInfomap_tree_set)
...
class Config(_object):
    ...
    def reset(self): return _infomap.Config_reset(self)
    ...
    def is3gram(self): return _infomap.Config_is3gram(self)
    def isMultiplexNetwork(self): return _infomap.Config_isMultiplexNetwork(self)
    def isStateNetwork(self): return _infomap.Config_isStateNetwork(self)
    ...
    if _newclass:multiplexAddMissingNodes = _swig_property(_infomap.Config_multiplexAddMissingNodes_get, _infomap.Config_multiplexAddMissingNodes_set)
    ...
    if _newclass:completeDanglingMemoryNodes = _swig_property(_infomap.Config_completeDanglingMemoryNodes_get, _infomap.Config_completeDanglingMemoryNodes_set)
    ...
    if _newclass:weightThreshold = _swig_property(_infomap.Config_weightThreshold_get, _infomap.Config_weightThreshold_set)
    ...
    if _newclass:variableMarkovTime = _swig_property(_infomap.Config_variableMarkovTime_get, _infomap.Config_variableMarkovTime_set)
    ...
    if _newclass:multiplexJSRelaxRate = _swig_property(_infomap.Config_multiplexJSRelaxRate_get, _infomap.Config_multiplexJSRelaxRate_set)
    ...
    if _newclass:multiplexJSRelaxLimit = _swig_property(_infomap.Config_multiplexJSRelaxLimit_get, _infomap.Config_multiplexJSRelaxLimit_set)
    ...
    if _newclass:resetConfigBeforeRecursion = _swig_property(_infomap.Config_resetConfigBeforeRecursion_get, _infomap.Config_resetConfigBeforeRecursion_set)
    ...
    if _newclass:printStateNetwork = _swig_property(_infomap.Config_printStateNetwork_get, _infomap.Config_printStateNetwork_set)
...
class Network(_object):
    ...
    def printStateNetwork(self, *args): return _infomap.Network_printStateNetwork(self, *args)
    ...
    def haveNode(self, *args): return _infomap.Network_haveNode(self, *args)
    ...
    def initNodeNames(self): return _infomap.Network_initNodeNames(self)
    def swapNodeNames(self, *args): return _infomap.Network_swapNodeNames(self, *args)
    def generateOppositeLinkMap(self, *args): return _infomap.Network_generateOppositeLinkMap(self, *args)
    def disposeLinks(self): return _infomap.Network_disposeLinks(self)
    def config(self): return _infomap.Network_config(self)
    def isFinalized(self): return _infomap.Network_isFinalized(self)
...
class Link(_object):
    ...
    if _newclass:n1 = _swig_property(_infomap.Link_n1_get, _infomap.Link_n1_set)
    __swig_setmethods__["n2"] = _infomap.Link_n2_set
    __swig_getmethods__["n2"] = _infomap.Link_n2_get
    if _newclass:n2 = _swig_property(_infomap.Link_n2_get, _infomap.Link_n2_set)
    __swig_setmethods__["weight"] = _infomap.Link_weight_set
    __swig_getmethods__["weight"] = _infomap.Link_weight_get
    if _newclass:weight = _swig_property(_infomap.Link_weight_get, _infomap.Link_weight_set)
...
class ComplementaryData(_object):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _infomap.new_ComplementaryData(*args)
        try: self.this.append(this)
        except: self.this = this
    def addExactMatch(self, *args): return _infomap.ComplementaryData_addExactMatch(self, *args)
    def addPartialMatch(self, *args): return _infomap.ComplementaryData_addPartialMatch(self, *args)
    def addShiftedMatch(self, *args): return _infomap.ComplementaryData_addShiftedMatch(self, *args)
    ...
    if _newclass:incompleteLink = _swig_property(_infomap.ComplementaryData_incompleteLink_get, _infomap.ComplementaryData_incompleteLink_set)
    ...
    if _newclass:exactMatch = _swig_property(_infomap.ComplementaryData_exactMatch_get, _infomap.ComplementaryData_exactMatch_set)
    ...
    if _newclass:sumWeightExactMatch = _swig_property(_infomap.ComplementaryData_sumWeightExactMatch_get, _infomap.ComplementaryData_sumWeightExactMatch_set)
    ...
    if _newclass:partialMatch = _swig_property(_infomap.ComplementaryData_partialMatch_get, _infomap.ComplementaryData_partialMatch_set)
    ...
    if _newclass:sumWeightPartialMatch = _swig_property(_infomap.ComplementaryData_sumWeightPartialMatch_get, _infomap.ComplementaryData_sumWeightPartialMatch_set)
    ...
    if _newclass:shiftedMatch = _swig_property(_infomap.ComplementaryData_shiftedMatch_get, _infomap.ComplementaryData_shiftedMatch_set)
    ...
    if _newclass:sumWeightShiftedMatch = _swig_property(_infomap.ComplementaryData_sumWeightShiftedMatch_get, _infomap.ComplementaryData_sumWeightShiftedMatch_set)
...
class MemNetwork(Network):
    ...
    __del__ = lambda self : None;
    def readInputData(self, filename = ""): return _infomap.MemNetwork_readInputData(self, filename)
    def addStateLink(self, *args): return _infomap.MemNetwork_addStateLink(self, *args)
    def addStateNode(self, *args): return _infomap.MemNetwork_addStateNode(self, *args)
    def finalizeAndCheckNetwork(self, printSummary = True): return _infomap.MemNetwork_finalizeAndCheckNetwork(self, printSummary)
    def printParsingResult(self, includeFirstOrderData = False): return _infomap.MemNetwork_printParsingResult(self, includeFirstOrderData)
    def numStateNodes(self): return _infomap.MemNetwork_numStateNodes(self)
    def numPhysicalNodes(self): return _infomap.MemNetwork_numPhysicalNodes(self)
    def stateNodeMap(self): return _infomap.MemNetwork_stateNodeMap(self)
    def stateNodeWeights(self): return _infomap.MemNetwork_stateNodeWeights(self)
    def totalStateNodeWeight(self): return _infomap.MemNetwork_totalStateNodeWeight(self)
    def stateLinkMap(self): return _infomap.MemNetwork_stateLinkMap(self)
    def numStateLinks(self): return _infomap.MemNetwork_numStateLinks(self)
    def totalStateLinkWeight(self): return _infomap.MemNetwork_totalStateLinkWeight(self)
    def totalMemorySelfLinkWeight(self): return _infomap.MemNetwork_totalMemorySelfLinkWeight(self)
    def stateNodes(self): return _infomap.MemNetwork_stateNodes(self)
    def printNetworkAsPajek(self, *args): return _infomap.MemNetwork_printNetworkAsPajek(self, *args)
    def printStateNetwork(self, *args): return _infomap.MemNetwork_printStateNetwork(self, *args)
    def disposeLinks(self): return _infomap.MemNetwork_disposeLinks(self)
...
class MultiplexNetwork(MemNetwork):
    __swig_setmethods__ = {}
    for _s in [MemNetwork]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, MultiplexNetwork, name, value)
    __swig_getmethods__ = {}
    for _s in [MemNetwork]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    ...
    __del__ = lambda self : None;
    def readInputData(self, filename = ""): return _infomap.MultiplexNetwork_readInputData(self, filename)
    def finalizeAndCheckNetwork(self, printSummary = True): return _infomap.MultiplexNetwork_finalizeAndCheckNetwork(self, printSummary)
    def addMultiplexLink(self, *args): return _infomap.MultiplexNetwork_addMultiplexLink(self, *args)
    def addMemoryNetworkFromMultiplexLinks(self): return _infomap.MultiplexNetwork_addMemoryNetworkFromMultiplexLinks(self)
...
class SNode(_object):
    ...
    def printState(self, indexOffset = 0): return _infomap.SNode_printState(self, indexOffset)
    ...
    if _newclass:stateIndex = _swig_property(_infomap.SNode_stateIndex_get, _infomap.SNode_stateIndex_set)
...
class LeafIterator(_object):
    ...
    def moduleIndex(self): return _infomap.LeafIterator_moduleIndex(self)
    ...
    def printState(self, indexOffset = 0): return _infomap.LeafIterator_printState(self, indexOffset)
    ...
    if _newclass:stateIndex = _swig_property(_infomap.LeafIterator_stateIndex_get, _infomap.LeafIterator_stateIndex_set)
...
class TreeIterator(_object):
    ...
    def moduleIndex(self): return _infomap.TreeIterator_moduleIndex(self)
    ...
    def printState(self, indexOffset = 0): return _infomap.TreeIterator_printState(self, indexOffset)
    ...
    if _newclass:stateIndex = _swig_property(_infomap.TreeIterator_stateIndex_get, _infomap.TreeIterator_stateIndex_set)
...
class ChildIterator(_object):
    ...
    def printState(self, indexOffset = 0): return _infomap.ChildIterator_printState(self, indexOffset)
    ...
    if _newclass:stateIndex = _swig_property(_infomap.ChildIterator_stateIndex_get, _infomap.ChildIterator_stateIndex_set)
